...
class LineFollowerNode(Node):
    def __init__(self):
        ...
        self.follower = LineFollowerFSM(
            ...
            advanced_follow_enabled=advanced_cfg.get("use_for_following", False),
            advanced_follow_error_deadband=advanced_cfg.get("follow_error_deadband", 12),
            advanced_follow_min_active_segments=advanced_cfg.get("follow_min_active_segments", 1),
